...
This is the **statistical power**. The _higher_ you set the statistical power, the _less likely_ the statistical results will return a _false "no difference"_ (aka, a false negative or a Type II error).
